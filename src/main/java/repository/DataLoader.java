...
//    // ====== API pública ======
//
//    public List<ArtistaService> cargarArtistas(String path) {
//        String json = readFile(path);
//        List<String> objs = splitTopLevelObjects(json);
//        List<ArtistaService> out = new ArrayList<>();
//        for (String o : objs) {
//            Map<String, Object> m = parseObject(o);
//
//            ArtistaService a = new ArtistaService();
//            a.nombre = (String) m.get("nombre");
//
//            @SuppressWarnings("unchecked")
//            List<Object> rolesRaw = (List<Object>) m.get("roles");
//            a.roles = rolesRaw == null ? Set.of()
//                    : rolesRaw.stream()
...
//            a.bandas = bandasRaw == null ? Set.of()
//                    : bandasRaw.stream().map(x -> (String) x)
//                        .collect(Collectors.toCollection(LinkedHashSet::new));
//
//            Object costo = m.get("costo");
//            a.costo = (costo instanceof Number) ? ((Number) costo).doubleValue() : 0.0;
//
//            Object max = m.get("maxCanciones");
//            a.maxCanciones = (max instanceof Number) ? ((Number) max).intValue() : 0;
//
//            out.add(a);
//        }
//        return out;
//    }
//
//    public List<CancionService> cargarCanciones(String path) {
//        String json = readFile(path);
//        List<String> objs = splitTopLevelObjects(json);
//        List<CancionService> out = new ArrayList<>();
//        for (String o : objs) {
//            Map<String, Object> m = parseObject(o);
//
//            CancionService c = new CancionService();
//            c.titulo = (String) m.get("titulo");
//            c.estado = TipoEstado.BORRADOR;
//
//            @SuppressWarnings("unchecked")
...
//            if (reqRaw != null) {
//                for (Object x : reqRaw) {
//                    TipoRol r = TipoRol.fromTexto((String) x);
//                    req.merge(r, 1, Integer::sum);
//                }
//            }
//            c.rolesRequeridos = req;
//
//            out.add(c);
//        }
//        return out;
//    }
//
//    public List<String> cargarArtistasBase(String path) {
//        String json = readFile(path);
//        List<Object> arr = parseTopLevelArray(json);
//        List<String> out = new ArrayList<>(arr.size());
//        for (Object o : arr) {
//            if (o instanceof String) out.add((String) o);
//            else throw new IllegalArgumentException("Se esperaba string en arreglo: " + o);
//        }
//        return out;
//    }
//
